/**
 * design 资产查看器注册表:九类资产 → 查看器组件(独立模块,便于单测)。
 */
...
import { MdViewer, ImageViewer, CodeViewer, VideoViewer, AudioViewer, PdfViewer, FontViewer, UnsupportedViewer } from './misc.js';

export { UnsupportedViewer };

export const ASSET_VIEWER_TYPES: readonly AssetType[] = ['page', 'component', 'icon', 'token', 'md', 'video', 'audio', 'pdf', 'font'];
